...
public class TimeUtil {
    ...
    /* *
     * @desc:获取年、月、日、时、分、秒字符串
     * @author: dx
     * @date: 2020-04-29 14:09:59
     * @param date :
     * @param unit :
     ...
     * @version: 1.0
     **/
    public synchronized static String getUnitTimeStr(Date date, int unit) {
        if (date == null || unit <= 0) return null;
        calendar.setTime(date);
        return String.valueOf(unit == UNIT_MONTH ? calendar.get(unit) + 1 : calendar.get(unit));
    }
    ...
    public static void main(String[] args) throws Exception {
        Date date = TimeUtil.parseDateYYYY_MM_DD_HH_MM_SS("2020-04-29 08:00:00");
        Date now = TimeUtil.parseDateYYYY_MM_DD_HH_MM_SS("2020-04-29 13:35:00");
        System.out.println((now.getTime() - date.getTime()) / (30 * 60 * 1000));
    }
}
